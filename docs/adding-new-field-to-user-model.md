...
```php
class User extends \kilyakus\module\user\models\User
{
...
You should override view file `@kilyakus/module/user/views/admin/_user.php` as described in [special guide](overriding-views.md)
...
```php
class RegistrationForm extends \kilyakus\module\user\models\RegistrationForm
{
    /**
     * @var string
     */
