...
```php
'facebook' => [
    'class'        => 'kilyakus\module\user\clients\Facebook',
    'clientId'     => 'APP_ID',
...
```php
'twitter' => [
    'class'          => 'kilyakus\module\user\clients\Twitter',
...
```php
'google' => [
    'class'        => 'kilyakus\module\user\clients\Google',
    'clientId'     => 'CLIENT_ID',
...
```php
'github' => [
    'class'        => 'kilyakus\module\user\clients\GitHub',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET',
],
```
...
```php
'vkontakte' => [
    'class'        => 'kilyakus\module\user\clients\VKontakte',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET',
]
```
...
```php
'yandex' => [
    'class'        => 'kilyakus\module\user\clients\Yandex',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET'
],
```
...
```php
'linkedin' => [
    'class'        => 'kilyakus\module\user\clients\LinkedIn',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET'
],
```
...
use kilyakus\module\user\controllers\SecurityController; 
