...
$this->title = Yii::t('easyii/market','Мои товары');
$this->params['breadcrumbs'][] = ['url' => Url::toRoute(['/user/profile/show','id' => $profile->user->id]), 'label' => Yii::t('user','Profile')];
$this->params['breadcrumbs'][] = $this->title;

$items = [
    [
        'label' => Yii::t('user','Мои товары'),
        'content' => $this->render('_provider',compact('items')),
        'active' => true,
        // 'linkOptions' => ['data-url' => Url::toRoute(['/user/market/tab','tab' => 1])]
    ],
    [
        'label' => Yii::t('user','Мой архив'),
        // 'content' => $this->render('_provider',compact('items')),
        'active' => false,
        'linkOptions' => ['data-url' => Url::toRoute(['/user/market/tab','tab' => 3])]
    ],
];
?>
<style>
