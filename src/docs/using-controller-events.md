...
```php
'user' => [
    'class' => \kilyakus\module\user\Module::className(),
    'controllerMap' => [
        'registration' => [
            'class' => \kilyakus\module\user\controllers\RegistrationController::className(),
            'on ' . \kilyakus\module\user\controllers\RegistrationController::EVENT_AFTER_REGISTER => function ($e) {
...
```php
\yii\base\Event::on(
    \kilyakus\module\user\controllers\RegistrationController::className(),
    \kilyakus\module\user\controllers\RegistrationController::EVENT_AFTER_CONFIRM,
    function () {        
