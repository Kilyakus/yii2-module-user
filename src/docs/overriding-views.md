...
'components' => [
    'view' => [
        'theme' => [
            'pathMap' => [
                '@kilyakus/module/user/views' => '@app/views/user'
            ],
        ],
    ],
],
...
In the above `pathMap` means that every view in @kilyakus/module/user/views will be first searched under `@app/views/user` and
