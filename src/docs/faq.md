...
'modules' => [
    'user' => [
        ...
        'controllerMap' => [
            'admin' => [
                'class'  => 'kilyakus\module\user\controllers\AdminController',
                'layout' => '//admin-layout',
            ],
        ],
    ],
...
use kilyakus\module\user\widgets\Login;
...
'modules' => [
    'user' => [
        ...
        'controllerMap' => [
            'recovery' => [
                'class' => \kilyakus\module\user\controllers\RecoveryController::class,
                'on ' . \kilyakus\module\user\controllers\RecoveryController::EVENT_AFTER_REQUEST => function (\kilyakus\module\user\events\FormEvent $event) {
                    \Yii::$app->controller->redirect(['/user/login']);
                    \Yii::$app->end();
                },
                'on ' . \kilyakus\module\user\controllers\RecoveryController::EVENT_AFTER_RESET => function (\kilyakus\module\user\events\ResetPasswordEvent $event) {
            ...
            'registration' => [
                'class' => \kilyakus\module\user\controllers\RegistrationController::class,
                'on ' . \kilyakus\module\user\controllers\RegistrationController::EVENT_AFTER_REGISTER => function (\kilyakus\module\user\events\FormEvent $event) {
                    \Yii::$app->controller->redirect(['/user/login']);
                    \Yii::$app->end();
                },
                'on ' . \kilyakus\module\user\controllers\RegistrationController::EVENT_AFTER_RESEND => function (\kilyakus\module\user\events\FormEvent $event) {
                    \Yii::$app->controller->redirect(['/user/login']);
                    \Yii::$app->end();
                },
            ],
