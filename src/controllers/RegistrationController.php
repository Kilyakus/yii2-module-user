...
use kilyakus\module\user\models\RegistrationForm;
use kilyakus\module\user\models\ResendForm;
...
class RegistrationController extends \bin\admin\components\AppController
{
