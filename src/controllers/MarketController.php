...
use bin\admin\modules\market\api\Market;

class MarketController extends \bin\admin\components\AppController
{
    ...
    public function actionIndex()
    {
        ...
        $items = Market::items(['where' => ['and',['created_by' => Yii::$app->user->identity->id],['status' => [0,1]]]]);
    ...
    {
        $items = Market::items(['where' => ['and',['created_by' => Yii::$app->user->identity->id],['status' => 2]]]);
